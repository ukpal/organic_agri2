...
<head>
    ...
    <title>Organic Agri Market</title>
    ...
    <!-- Font Icons css -->
    <link rel="stylesheet" href="{{ asset('assets/site/css/font-icons.css') }}">
    <!-- plugins css -->
                ...
                <div class="row">
                    <div class="col-md-7">
                        <div class="ltn__top-bar-menu">
                            <ul>
                                <li><a href="#"><i class="icon-placeholder"></i> 83, Jodhpur Park, Kolkata 700068</a></li>
                                <li><a href="mailto:organicagrimarket@gmail.com"><i class="icon-mail"></i> organicagrimarket@gmail.com</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-md-5">
                                ...
                                <ul>
                                    <li>
                                        ...
                                        <div class="ltn__drop-menu ltn__currency-menu ltn__language-menu">
                                            <ul>
                                                <li><a href="#" class="dropdown-toggle"><span class="active-currency">Change Language</span></a>
                                                    <ul>
                ...
                <div class="row">
                    <div class="col">
                        <div class="site-logo-wrap">
                            <div class="site-logo">
                                <a href="{{url('/')}}"><img src="{{ asset('assets/site/img/logo.png') }}" alt="Logo"></a>
                            </div>
                        </div>
                    </div>
                            ...
                            <nav>
                                <div class="ltn__main-menu">
                                    <ul>
                                        ...
                                        <li class="menu-icon"><a href="product-catagories.html">PRODUCTS</a> </li>
                                        <li class="menu-icon"><a href="contact.html">CONTACT US</a></li>
                                        @guest
                                        <li class="special-link"><a href="{{route('login')}}">SELLER LOGIN / REGISTER</a></li>
                                        @endguest                                      
                                    </ul>									
                                </div>
                            </nav>
