<footer class="footer">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-6">
                <script>document.write(new Date().getFullYear())</script> © Organic Agri Market.
            </div>
            <div class="col-sm-6">
                <div class="text-sm-end d-none d-sm-block">
                    Design & Develop by <a href="https://technikology.com/" class="text-decoration-underline">Technikology</a>
                </div>
            </div>
        </div>
    </div>
