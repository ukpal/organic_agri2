...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Login | Organic Agri Market - Admin</title>
                                ...
                                <div class="d-flex flex-column h-100">
                                    <div class="mb-2 mb-md-2 text-center">
                                        <a href="{{url('/')}}" class="d-block auth-logo">
                                            <img src="{{asset('assets/site/img/xxxORGANIC-AGRI-MARKET_1_crop.jpg')}}" alt="" height="90"> 
                                            {{-- <span class="logo-txt">Organic Agri Market</span> --}}
                                        </a>
                                    </div>
                                    <div class="auth-content my-auto">
                                        <div class="text-center">
                                            <h5 class="mb-0">Welcome Back !</h5>
                                            <p class="text-muted mt-2">Sign in to continue to Organic Agri Market.</p>
                                        </div>
                                        <form class="mt-4 pt-2" action="{{url('admin/login')}}" method="POST">
                                            @csrf
                                            <div class="form-floating form-floating-custom mb-4">
                                                <input type="email" class="form-control" id="input-username" placeholder="Enter User Email" name="email">
                                    ...
                                    <div class="mt-4 mt-md-5 text-center">
                                        <p class="mb-0">© <script>document.write(new Date().getFullYear())</script> Organic Agri Market   . Crafted with <i class="mdi mdi-heart text-danger"></i> Technikology</p>
                                    </div>
                                </div>
                            </div>
                        </div>
