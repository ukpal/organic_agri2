...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Dashboard | Organic Agri Market - Admin</title>
                    ...
                    <div class="d-flex">
                        ...
                        <div class="navbar-brand-box">
                            <a href="index.html" class="logo logo-dark text-center">
                                <span class="logo-sm">
                                    <img src="{{ asset('assets/site/img/logo.png') }}" alt="" height="30">
                                </span>
                                <span class="logo-lg">
                                    <img src="{{ asset('assets/site/img/logo.png') }}" alt="" height="40"> 
                                </span>
                            </a>
                            ...
                            <a href="index.html" class="logo logo-light text-center">
                                ...
                                <span class="logo-lg">
                                    <img src="{{ asset('assets/site/img/xxxORGANIC-AGRI-MARKET_1_crop.jpg') }}" alt="" height="60"> 
                                </span>
                            </a>
                        </div>
